	    ...
	    <div>
			<form action="../../V1/memorial/post/index.php" method="post" class="form-message" enctype="multipart/form-data">
				...
				<div class="row">
				    ...
				    <div class="col s4">
						<p class="center-align">
				            <label> 
				                ...
				                <input style="display:none" type="file"  onchange="mudar()" accept="image/*" name="file" id="filefoto">
				            </label>			
						</p>       
				    </div>
				    ...
				    <div class="col s6">
						...
						<input type="text" name="nome_k" id="nome_k" placeholder="Nome do malogrado" />
						...
						<input type="date" class="" id="data_nascimento_k" name="data_nascimento_k"  />

						<label for="data_morte_k">Data da morte</label>
						<input type="date" class="" id="data_morte_k" name="data_morte_k"  />

						<label for="data_funeral_k">Data do funeral(Opcional)</label>
						<input type="date" class="" id="data_funeral_k" name="data_funeral_k"  />

						<label for="local_funeral_k">Local do funeral</label>
						<input type="text"  id="local_funeral_k" name="local_funeral_k"  />

					    <div class="file-field input-field">
					      <div class="btn">
					        <span>Boletim de óbito</span>
					        <input type="file"  name="boletim_k" id="boletim_k" />
					      </div>
						...
						<textarea name="bibliografia_k" id="bibliografia_k" class="materialize-textarea" placeholder="bibliografia" cols="30" rows="10" maxlength="266"></textarea>

						<div class="call-to-action" style="display: flex; justify-content: space-between; align-items: center;">
							<input type="submit" value="Registar" class="waves-effect waves-light btn-large"> 
						</div>
					</div>
				</div>
			</form>        
